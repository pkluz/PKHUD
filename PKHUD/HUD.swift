...
public enum HUDContentType {
    ...
    case labeledSuccess(title: String?, subtitle: String? = nil)
    case labeledError(title: String?, subtitle: String? = nil)
    case labeledProgress(title: String?, subtitle: String? = nil)
    case labeledImage(image: UIImage?, title: String?, subtitle: String? = nil)
    case labeledRotatingImage(image: UIImage?, title: String?, subtitle: String? = nil)
